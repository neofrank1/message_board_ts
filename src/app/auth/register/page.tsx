            ...
            <div className="rounded-lg overflow-hidden w-full max-w-md shadow-2xl shadow-slate-400">
                ...
                <CardBody className="bg-gray-100 p-4">
                    <div className="flex flex-col gap-4">
                        <h1 className="text-2xl font-bold items-center justify-center flex text-shadow-sm">Register</h1>
                        <input className="w-full shadow-md rounded-lg p-2" type="email" placeholder="Email" />
                        <input className="w-full shadow-md rounded-lg p-2" type="password" placeholder="Password" />
                        <input className="w-full shadow-md rounded-lg p-2" type="password" placeholder="Confirm Password" />
                        <button className="w-full shadow-md rounded-lg p-2 hover:bg-slate-500 hover:text-white">Register</button>
                ...
                <CardFooter className="bg-gray-100 p-4 rounded-b-lg flex justify-between items-center">
                    <p className="text-sm text-gray-500">Already have an account? <Link className="text-gray-600 underline" href={'/auth/login'}>Login</Link></p>
                </CardFooter>
            </div>
        </div>
    );
